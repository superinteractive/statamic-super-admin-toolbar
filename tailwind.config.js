...
module.exports = {
    ...
    theme: {
        extend: {
            boxShadow: {
                'super-toolbar': '0px 6px 12px 0px rgba(0,0,0,0.02), 0px 0.5px 1px 0px rgba(0,0,0,0.10), 0px -1px 2px 0px rgba(0,0,0,0.10) inset, 0px 2px 4px 0px rgba(0,0,0,0.10), 0px 1px 1px 0px #FFF inset',
